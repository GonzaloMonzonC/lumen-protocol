> **📘 EXTENDED DOCUMENTATION** — Full protocol spec, benchmarks, architecture deep-dive.
> Looking for the quick overview? → **[README.md](README.md)**
...
/LUMEN/
├── README.md               ← this file
├── RFC_LUMEN.md             ← formal IETF-style RFC (12 sections)
├── SPEC_DEV.md              ← developer reference specification (9 sections)

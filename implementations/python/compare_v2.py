"""Compare Python v2 (optimized) vs TypeScript benchmark results."""
import json, os

os.chdir(os.path.dirname(os.path.abspath(__file__)))

with open("bench_results_v2.json", "r", encoding="utf-8") as f:
    py = json.load(f)
...
print(f"Python v2:   {len(py['results'])} results")

...
import os
dream_path = os.path.expanduser("~/Documents/GitHub/PRIVATE_REPO/src/dream")
...
idx_path = os.path.expanduser("~/Documents/GitHub/PRIVATE_REPO/src/index.ts")
...
wrangler_path = os.path.expanduser("~/Documents/GitHub/PRIVATE_REPO/wrangler.toml")
...
scoring_path = os.path.expanduser("~/Documents/GitHub/PRIVATE_REPO/src/dream/scoring.js")

...
pub fn generate_tools(n: usize) -> Vec<Value> {
    let tool_templates = [
        (
            "search_code",
            "Search for code patterns in the workspace using regex or semantic queries",
            &[
        ...
        (
            "get_diagnostics",
            "Retrieve compiler and linter errors from the workspace",
            &[
                (
                    "file_path",
                    "string",
                    "Optional file path to scope diagnostics",
                ),
                (
                    "severity",
                    "string",
        ...
        (
            "semantic_search",
            "Search the codebase using natural language understanding",
            &[
                (
                    "query",
                    "string",
        ...
        (
            "create_rule",
            "Create or update a project rule or coding standard",
            &[
        ...
        (
            "manage_memory",
            "Store, retrieve, and update persistent memory across sessions",
            &[
                (
                    "operation",
                    "string",
                    "Memory operation: view, create, update, delete",
                ),

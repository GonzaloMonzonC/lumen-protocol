...
fn main() {
    ...
    // FIX vendor LUMEN (19-sep-2026): el gate debe mirar el TARGET, no el HOST.
    // #[cfg(target_os = "windows")] en un build script evalúa el HOST: al
    // cross-compilar desde Windows a Linux añadía -ladvapi32 al enlace Linux
    // y fallaba ("unable to find static system library 'advapi32'").

...
> **Tools (MCP, verificado)**: 81 thinking + 13 filesystem + 2 web + 19 PDB = **115 tools total**
> **Plugin**: `lumen-shm-bridge` (Hermes Agent) — subconjunto vía SHM (35 thinking + 13 filesystem + 2 web = 50)
